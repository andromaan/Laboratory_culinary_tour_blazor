...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuisineGastroFacility", b =>
                {
                    ...
                    b.ToTable("GastroFacilitieCuisine", (string)null);
                });

            modelBuilder.Entity("culinary_tour.Core.Entities.Cuisine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("culinary_tour.Core.Entities.FacilityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("culinary_tour.Core.Entities.GastroFacility", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CuisineGastroFacility", b =>
                {
                    b.HasOne("culinary_tour.Core.Entities.Cuisine", null)
                        .WithMany()
                        .HasForeignKey("CuisinesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("culinary_tour.Core.Entities.GastroFacility", null)
                        .WithMany()
            ...
            modelBuilder.Entity("culinary_tour.Core.Entities.GastroFacility", b =>
                {
                    b.HasOne("culinary_tour.Core.Entities.FacilityType", "Type")
